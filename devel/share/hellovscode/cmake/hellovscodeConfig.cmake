...
if("TRUE" STREQUAL "TRUE")
  set(hellovscode_SOURCE_PREFIX /home/zkk666/demo02_ws/src/hellovscode)
  set(hellovscode_DEVEL_PREFIX /home/zkk666/demo02_ws/devel)
  ...
  set(hellovscode_INSTALL_PREFIX /home/zkk666/demo02_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  elseif(NOT " " STREQUAL " ")
    ...
    set(_report "Report the problem to the maintainer 'zkk666 <zkk666@todo.todo>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'hellovscode' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/zkk666/demo02_ws/src/hellovscode/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/zkk666/demo02_ws/devel/lib;/home/zkk666/demo01_ws/devel/lib;/opt/ros/melodic/lib)
...
foreach(depend ${depends})
  ...
  list(APPEND hellovscode_EXPORTED_TARGETS ${${hellovscode_dep}_EXPORTED_TARGETS})
endforeach()
